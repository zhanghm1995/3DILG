...
torchrun --nproc_per_node=1 --master_port=$MASTER_PORT run_vqpc.py \
         ...
         --output_dir output/vqpc_stage1_random_2048_codes_only_fine_loss_resume_e17_cd_100_hd_1_test \
         --log_dir output/vqpc_stage1_random_2048_codes_only_fine_loss_resume_e17_cd_100_hd_1_test/logs/ \
         --model vqpc_256_2048_1024 --data_path ./data/PU1K/train/pu1k_poisson_256_poisson_1024_pc_2500_patch50_addpugan.h5 \
