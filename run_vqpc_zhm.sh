...
#SBATCH --gres=gpu:1
#SBATCH -o /mntnfs/cui_data4/yanchengwang/3DILG/output/stage1_random4_fps2_positinal_embedding/%j.out
#SBATCH -e /mntnfs/cui_data4/yanchengwang/3DILG/output/stage1_random4_fps2_positinal_embedding/%j.out
...
torchrun --nproc_per_node=1 --master_port=$MASTER_PORT run_vqpc.py \
         ...
         --output_dir output/stage1_random4_fps2_positinal_embedding \
         --log_dir output/stage1_random4_fps2_positinal_embedding/logs/ \
