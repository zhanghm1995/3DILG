...
#SBATCH --gres=gpu:1
#SBATCH -o /mntnfs/cui_data4/yanchengwang/3DILG/output/stage2_random_4_pe_EMA_VQ_offset/%j.out
#SBATCH -e /mntnfs/cui_data4/yanchengwang/3DILG/output/stage2_random_4_pe_EMA_VQ_offset/%j.out
...
torchrun --nproc_per_node=1 --master_port=$MASTER_PORT run_vqpc.py \
         ...
         --output_dir output/stage2_random_4_pe_EMA_VQ_offset \
         --log_dir output/stage2_random_4_pe_EMA_VQ_offset/logs/ \
